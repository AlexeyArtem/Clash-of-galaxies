...
public class CardView : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        // Ќачинать перетаскивание можно, только если карта находитс€ в поле руки игрока или в поле выброса карты и если сейчас ход игрока
        ...
        // ѕодсвечивание карт противника дл€ атаки, когда мы берем еЄ в руку
